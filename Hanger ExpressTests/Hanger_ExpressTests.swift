...
struct Hanger_ExpressTests {
    ...
    @Test func hostedShipFeedEndpointsPreferPagesDevAndFallbackToGitHubPages() async throws {
        ...
        #expect(
            HostedShipFeedEndpoints.itemTranslationURLs(for: .simplifiedChinese) == [
                URL(string: "https://hangar-express-translations.liuchen2004.workers.dev/item-translations/zh-Hans.json")!,
    ...
    @Test func hostedHangarItemTranslationFeedVerifiesCloudflareResponseMetadata() throws {
